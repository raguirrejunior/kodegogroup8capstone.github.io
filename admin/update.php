...
if (isset($_POST['edit'])) {
    ...
    $queryUsers = "SELECT * FROM register WHERE email = '$email'";
...
if (isset($_POST['update'])) {
    ...
    $queryUpdate = "UPDATE register SET first_name = '$first_name', last_name = '$last_name', roles = '$roles', contact='$contact', access ='$access' WHERE email = '$email'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="./update.php" method="post" class="row">
                                    <div class="lead">Profile Information</div>
                                    <div class="col-lg-6 form-group mt-2">
                                        <label class="form-label" for="first_name">First Name</label>
                                        <input class="form-control" type="text" name="first_name" placeholder="Enter First Name" value="<?php echo $row['first_name'] ?>">
                                    </div>
                                    <div class="col-lg-6 form-group mt-2">
                                        <label class="form-label" for="last_name">Last Name</label>
                                        <input class="form-control" type="text" name="last_name" placeholder="Enter Last Name" value="<?php echo $row['last_name'] ?>">
                                    </div>
                                    <div class="col-lg-6 form-group mt-2">
                                        <label class="form-label" for="roles">Company Role</label>
                                        <select class="form-select" name="roles">
                                            <option value="">Select Company Role</option>
                                            <option value="Sales Manager" <?php echo ($row['roles'] == 'Sales Manager') ? "selected" : " " ?>>Sales Manager</option>
                                            <option value="Sales Representative" <?php echo ($row['roles'] == 'Sales Representative') ? "selected" : " " ?>>Sales Representative</option>
                                        </select>
                                    </div>
                                    <div class=" col-lg-6 form-group mt-2">
                                        <label class="form-label" for="contact">Contact Number</label>
                                        <input class="form-control" type="number" name="contact" placeholder="Enter Contact Number" value="<?php echo $row['contact'] ?>">
                                    </div>
                                    <div class="lead mt-4">Access Information</div>
                                    <div class="col-lg-12 form-group mt-2">
                                        <label class="form-label" for="email">Email</label>
                                        <input class="form-control w-50" type="email" name="email" placeholder="Email" value="<?php echo $row['email'] ?>" readonly>
                                    </div>
                                    <div class="col-lg-12 form-group mt-2">
                                        <label class="form-label" for="access">Access Type</label>
                                        <select class="form-select w-50" name="access">
