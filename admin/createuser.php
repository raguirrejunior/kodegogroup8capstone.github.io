                ...
                <?php if ($isAdmin) { ?>
                    <div class="mt-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="./create.php" method="post" class="row">
                                    ...
                                    <div class="col-lg-6 form-group mt-2">
                                        ...
                                        <select class="form-select" name="roles">
                                            <option selected>Select Company Role</option>
                                    ...
                                    <div class="col-lg-12 form-group mt-2">
                                        ...
                                        <input class="form-control w-50" type="email" name="email" placeholder="Email" required>
                                    </div>
                                    <div class="col-lg-12 form-group mt-2">
                                        <label class="form-label" for="password">Password</label>
                                        <input class="form-control w-50" type="password" name="password" placeholder="Password" required>
                                    </div>
                                    <div class="col-lg-12 form-group mt-2">
