...
if (isset($_POST['edit'])) {
    ...
    $queryUsers = "SELECT * FROM customer WHERE email = '$email'";
...
if (isset($_POST['update'])) {
    ...
    $queryUpdate = "UPDATE customer SET first_name = '$first_name', last_name = '$last_name', company_name = '$company_name', email = '$email', contact='$contact', address ='$address' WHERE customer_id = $customer_id";
...
<head>
    ...
    <title>Update Customer | RVT</title>
    <style>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex">
                                ...
                                <a href="./customer.php" class="btn btn-secondary ms-auto"></i>Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="./customerupdate.php" method="post" class="row">
                                        <div class="lead">Customer Information</div>
                                        <div class="form-group mt-2">
                                            <input class="form-control" type="hidden" name="customer_id" value="<?php echo $row['customer_id'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input class="form-control" type="text" name="company_name" placeholder="Enter Company Name" value="<?php echo $row['company_name'] ?>">
                                        </div>
                                        <div class="form-group mt-2">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input class="form-control" type="text" name="address" placeholder="Enter Address" value="<?php echo $row['address'] ?>">
                                        </div>
                                ...
                                <div class="col-lg-6 text-center">
                                    <img src="../../img/cus2.png" alt="supplier" class="img-fluid" width="500">
                                </div>
                            </div>
                        </div>
                    </div>
