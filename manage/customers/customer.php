...
<body>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h3>Customers</h3>
                                    <a href="./customercreate.php" class="btn btn-primary ms-auto"><i class="bi bi-plus-lg"></i> Add Customer</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex">
                                ...
                                <div class="table-responsive mt-2">
                                    <table id="cxtab" class="table table-bordered align-middle table-hover">
                                        <thead>
                                            ...
                                            <th><a style="text-decoration: none;" href="?column=company_name&sort=<?php echo $sort ?>">Company Name</a></th>
                                        ...
                                        <?php while ($row = mysqli_fetch_array($customerList)) {  ?>
                                            <tr>
                                                <td><input type="checkbox" name="cust" value="<?php echo $row['customer_id'] ?>"></td>
    ...
    <script>
        function toggle(source) {
            checkboxes = document.getElementsByName("cust");
