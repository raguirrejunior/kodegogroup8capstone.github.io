                    ...
                    <div class="mt-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h3>Products</h3>
                                    <a href="./productcreate.php" class="btn btn-primary ms-auto"><i class="bi bi-plus-lg"></i> Add Product</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex">
                                ...
                                <div class="table-responsive mt-2">
                                    <table id="pdttab" class="table table-bordered align-middle table-hover">
                                        <thead class="table-light">
                                            <th width="2%" class="text-center"><input type="checkbox" onclick="toggle(this)"></th>
                                            <th><a style="text-decoration: none;" href="?column=model&sort=<?php echo $sort ?>">Model</a></th>
                                            <th><a style="text-decoration: none;" href="?column=category&sort=<?php echo $sort ?>">Category</a></th>
                                            <th><a style="text-decoration: none;" href="?column=supplier_id&sort=<?php echo $sort ?>">Supplier</a></th>
                                            <th><a style="text-decoration: none;" href="?column=quantity&sort=<?php echo $sort ?>">Quantity</a></th>
                                            <th><a style="text-decoration: none;" href="?column=srp&sort=<?php echo $sort ?>">Price per Unit</a></th>
                                            <th width="5%" class="text-center">Actions</th>
                                        </thead>
                                        <?php while ($row = mysqli_fetch_array($productList)) {  ?>
                                            <tr>
                                                <td><input type="checkbox" name="prod" value="<?php echo $row['product_id'] ?>"></td>
                                                <td><?php echo $row['model'] ?></td>
                                                <td><?php echo $row['category'] ?></td>
                                                <td><?php echo $row['supplier_name'] ?></td>
                                                <td><?php echo $row['quantity'] ?></td>
                                                <td>Php <?php echo $row['srp'] ?></td>

                                                <td class="d-flex flex-row">
                                                    <form action="./productview.php" method="post">
                                                        <button class="btn btn-sm btn-transparent" type="submit" value="view" name="view" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i class="bi bi-eye"></i></button>
