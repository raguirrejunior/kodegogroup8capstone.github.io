...
if (isset($_POST['edit'])) {
    ...
    $queryUsers = "SELECT * FROM supplier WHERE email = '$email'";
...
if (isset($_POST['update'])) {
    ...
    $queryUpdate = "UPDATE supplier SET supplier_name = '$supplier_name', email = '$email', contact='$contact', address ='$address' WHERE supplier_id = $supplier_id";
...
<head>
    ...
    <title>Update Supplier | RVT</title>
    <style>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex">
                                ...
                                <a href="./supplier.php" class="btn btn-secondary ms-auto"></i>Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="./supplierupdate.php" method="post" class="row">
                                        <div class="lead">Supplier Information</div>
                                        <div class="form-group mt-2">
                                            <input class="form-control" type="hidden" name="supplier_id" value="<?php echo $row['supplier_id'] ?>">
                                        </div>
                                        <div class="form-group mt-2">
                                            <label class="form-label" for="supplier_name">Supplier Name</label>
                                            <input class="form-control" type="text" name="supplier_name" placeholder="Enter Supplier Name" value="<?php echo $row['supplier_name'] ?>">
                                        </div>
                                        <div class="form-group mt-2">
                                            <label class="form-label" for="email">Email</label>
                                            <input class="form-control" type="email" name="email" placeholder="Enter Email Address" value="<?php echo $row['email'] ?>">
                                        </div>
                                        <div class="form-group mt-2">
                                ...
                                <div class="col-lg-6 text-center">
                                    <img src="../../img/sup2.png" alt="supplier" class="img-fluid" width="450">
                                </div>
                            </div>
                        </div>
                    </div>
