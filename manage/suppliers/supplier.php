...
<body>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h3>Suppliers</h3>
                                    <a href="./suppliercreate.php" class="btn btn-primary ms-auto"><i class="bi bi-plus-lg"></i> Add Supplier</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex">
                                ...
                                <div class="table-responsive mt-2">
                                    <table id="suptab" class="table table-bordered align-middle table-hover">
                                        <thead class="table-light">
                                            <th width="2%" class="text-center"><input type="checkbox" onclick="toggle(this)"></th>
                                            <th><a style="text-decoration: none;" href="?column=supplier_name&sort=<?php echo $sort ?>">Supplier Name</a></th>
                                            <th><a style="text-decoration: none;" href="?column=email&sort=<?php echo $sort ?>">Email</a></th>
                                            <th><a style="text-decoration: none;" href="?column=contact&sort=<?php echo $sort ?>">Contact No.</a></th>
                                            <th><a style="text-decoration: none;" href="?column=address&sort=<?php echo $sort ?>">Address</a></th>
                                            <th width="5%">Actions</th>
                                        </thead>
                                        <?php while ($row = mysqli_fetch_array($supplierList)) {  ?>
                                            <tr>
                                                <td><input type="checkbox" name="sup" value="<?php echo $row['supplier_id'] ?>"></td>
    ...
    <script>
        function toggle(source) {
            checkboxes = document.getElementsByName("sup");
